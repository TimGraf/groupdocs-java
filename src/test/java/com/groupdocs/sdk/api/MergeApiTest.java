...
public class MergeApiTest extends AbstractUnitTest {
	...
	@Test
	public void testGetQuestionnaireByCollector() throws Exception {
		// sample parameters
		String userId = "userId";
		String collectorId = "collectorId";
		
		String resourcePath = "/merge/{userId}/questionnaires/collector/{collectorId}".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "collectorId" + "}", String.valueOf(collectorId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.GET).withHeader("Content-Type", MediaType.TEXT_HTML);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/GetQuestionnaireByCollector.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			GetQuestionnaireResponse response = api.GetQuestionnaireByCollector(userId, collectorId);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testGetQuestionnairesByName() throws Exception {
		// sample parameters
		String userId = "userId";
		String name = "name";
		String status = "status";
		...
		String resourcePath = "/merge/{userId}/questionnaires/filter".replace("{" + "userId" + "}", String.valueOf(userId));
		...
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/GetQuestionnairesByName.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			GetQuestionnairesResponse response = api.GetQuestionnairesByName(userId, name, status, pageNumber, pageSize, orderBy, isAscending);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testDeleteQuestionnairesList() throws Exception {
		// sample parameters
		String userId = "userId";
		List<String> body = getSampleRequest("merge/payload/DeleteQuestionnairesList.json", new TypeReference<List<String>>(){});
		
		String resourcePath = "/merge/{userId}/questionnaires/list".replace("{" + "userId" + "}", String.valueOf(userId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.DELETE).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/DeleteQuestionnairesList.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			DeleteQuestionnaireListResponse response = api.DeleteQuestionnairesList(userId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testDeleteDataSourceList() throws Exception {
		// sample parameters
		String userId = "userId";
		List<String> body = getSampleRequest("merge/payload/DeleteDataSourceList.json", new TypeReference<List<String>>(){});
		
		String resourcePath = "/merge/{userId}/datasources/list".replace("{" + "userId" + "}", String.valueOf(userId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.DELETE).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/DeleteDataSourceList.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			DeleteDatasourceListResponse response = api.DeleteDataSourceList(userId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testDeleteQuestionnaireExecutionList() throws Exception {
		// sample parameters
		String userId = "userId";
		List<String> body = getSampleRequest("merge/payload/DeleteQuestionnaireExecutionList.json", new TypeReference<List<String>>(){});
		
		String resourcePath = "/merge/{userId}/questionnaires/executions/list".replace("{" + "userId" + "}", String.valueOf(userId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.DELETE).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/DeleteQuestionnaireExecutionList.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			DeleteQuestionnaireExecutionListResponse response = api.DeleteQuestionnaireExecutionList(userId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testDeleteQuestionnaireCollectorList() throws Exception {
		// sample parameters
		String userId = "userId";
		List<String> body = getSampleRequest("merge/payload/DeleteQuestionnaireCollectorList.json", new TypeReference<List<String>>(){});
		
		String resourcePath = "/merge/{userId}/questionnaires/collectors/list".replace("{" + "userId" + "}", String.valueOf(userId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.DELETE).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/DeleteQuestionnaireCollectorList.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			DeleteQuestionnaireCollectorListResponse response = api.DeleteQuestionnaireCollectorList(userId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testDecorateQuestionnaireCollector() throws Exception {
		// sample parameters
		String userId = "userId";
		String collectorId = "collectorId";
		QuestionnaireCollectorStyle body = getSampleRequest("merge/payload/DecorateQuestionnaireCollector.json", new TypeReference<QuestionnaireCollectorStyle>(){});
		
		String resourcePath = "/merge/{userId}/questionnaires/collectors/{collectorId}/decorate".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "collectorId" + "}", String.valueOf(collectorId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.POST).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/DecorateQuestionnaireCollector.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			AddQuestionnaireCollectorStyleResponse response = api.DecorateQuestionnaireCollector(userId, collectorId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testGetQuestionnaireCollectorStyle() throws Exception {
		// sample parameters
		String userId = "userId";
		String collectorId = "collectorId";
		
		String resourcePath = "/merge/{userId}/questionnaires/collector/{collectorId}/style".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "collectorId" + "}", String.valueOf(collectorId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.GET).withHeader("Content-Type", MediaType.TEXT_HTML);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/GetQuestionnaireCollectorStyle.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			GetQuestionnaireCollectorStyleResponse response = api.GetQuestionnaireCollectorStyle(userId, collectorId);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	public void testGetTemplates() throws Exception {
		...
		try {
			GetTemplatesResponse response = api.GetTemplates(userId, orderBy, isAscending);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testGetDocumentByQuestionnaire() throws Exception {
		// sample parameters
		String userId = "userId";
		String questionnaireId = "questionnaireId";
		
		String resourcePath = "/merge/{userId}/questionnaires/{questionnaireId}/document".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "questionnaireId" + "}", String.valueOf(questionnaireId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.GET).withHeader("Content-Type", MediaType.TEXT_HTML);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/GetDocumentByQuestionnaire.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			GetQuestionnaireDocumentResponse response = api.GetDocumentByQuestionnaire(userId, questionnaireId);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	public void testCreateQuestionnaireTemplate() throws Exception {
		...
		String userId = "userId";
		String fileId = "fileId";
		List<TemplateEditorField> body = getSampleRequest("merge/payload/CreateQuestionnaireTemplate.json", new TypeReference<List<TemplateEditorField>>(){});
		
		String resourcePath = "/merge/{userId}/files/{fileId}/templates".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "fileId" + "}", String.valueOf(fileId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.POST).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/CreateQuestionnaireTemplate.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			CreateQuestionnaireTemplateResponse response = api.CreateQuestionnaireTemplate(userId, fileId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testAddQuestionnaireTemplateFields() throws Exception {
		// sample parameters
		String userId = "userId";
		String fileId = "fileId";
		List<TemplateEditorField> body = getSampleRequest("merge/payload/AddQuestionnaireTemplateFields.json", new TypeReference<List<TemplateEditorField>>(){});
		
		String resourcePath = "/merge/{userId}/files/{fileId}/templates/add".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "fileId" + "}", String.valueOf(fileId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.POST).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/AddQuestionnaireTemplateFields.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			GetQuestionnaireTemplateResponse response = api.AddQuestionnaireTemplateFields(userId, fileId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testUpdateQuestionnaireTemplateFields() throws Exception {
		// sample parameters
		String userId = "userId";
		String fileId = "fileId";
		List<TemplateEditorField> body = getSampleRequest("merge/payload/UpdateQuestionnaireTemplateFields.json", new TypeReference<List<TemplateEditorField>>(){});
		
		String resourcePath = "/merge/{userId}/files/{fileId}/templates/update".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "fileId" + "}", String.valueOf(fileId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.PUT).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/UpdateQuestionnaireTemplateFields.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			GetQuestionnaireTemplateResponse response = api.UpdateQuestionnaireTemplateFields(userId, fileId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
	...
	@Test
	public void testDeleteQuestionnaireTemplateFields() throws Exception {
		// sample parameters
		String userId = "userId";
		String fileId = "fileId";
		List<TemplateEditorField> body = getSampleRequest("merge/payload/DeleteQuestionnaireTemplateFields.json", new TypeReference<List<TemplateEditorField>>(){});
		
		String resourcePath = "/merge/{userId}/files/{fileId}/templates/delete".replace("{" + "userId" + "}", String.valueOf(userId)).replace("{" + "fileId" + "}", String.valueOf(fileId));
		
		ClientDriverRequest mockRequest = onRequestTo(resourcePath).withMethod(Method.DELETE).withHeader("Content-Type", MediaType.APPLICATION_JSON);
		// add query parameters to expectation
		mockRequest = mockRequest.withParam("signature", Pattern.compile(".*"));
		// read response json from file
		String responseBody = getSampleResponse("merge/DeleteQuestionnaireTemplateFields.json");
		
		ClientDriverResponse mockResponse = giveResponse(responseBody).withStatus(200);
		driver.addExpectation(mockRequest, mockResponse);
		
		try {
			GetQuestionnaireTemplateResponse response = api.DeleteQuestionnaireTemplateFields(userId, fileId, body);
			// this ensures that json was successfully deserialized into corresponding model object
			assertSameJson(responseBody, response);
