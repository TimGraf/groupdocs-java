...
public class SignatureApi {
  ...
  public SignatureFormResponse CreateSignatureForm (String userId, String name, SignatureFormSettings body, String templateGuid, Integer assemblyGuid) throws ApiException {
  ...
  public SignatureFormFieldsResponse GetSignatureFormParticipantFields (String userId, String formId, String documentId, String participantId) throws ApiException {
  ...
  public SignatureStatusResponse DelegateEnvelopeRecipient (String userId, String envelopeId, String recipientId, String lastname, String email, String firstname) throws ApiException {
    ...
    // verify required params are set
    if(userId == null || envelopeId == null || recipientId == null || lastname == null || email == null || firstname == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  public SignatureEnvelopeRecipientResponse AddSignatureEnvelopeRecipient (String userId, String envelopeId, Integer order, String firstname, String email, String role, String lastname) throws ApiException {
    ...
    // verify required params are set
    if(userId == null || envelopeId == null || firstname == null || email == null || role == null || lastname == null ) {
       throw new ApiException(400, "missing required params");
    }
    if(!"null".equals(String.valueOf(order)))
      queryParams.put("order", String.valueOf(order));
  ...
  public SignatureEnvelopeRecipientResponse ModifySignatureEnvelopeRecipient (String userId, String envelopeId, String recipientId, Integer order, String email, String firstname, String role, String lastname) throws ApiException {
    ...
    // verify required params are set
    if(userId == null || envelopeId == null || recipientId == null || email == null || firstname == null || role == null || lastname == null ) {
       throw new ApiException(400, "missing required params");
    }
    if(!"null".equals(String.valueOf(order)))
      queryParams.put("order", String.valueOf(order));
